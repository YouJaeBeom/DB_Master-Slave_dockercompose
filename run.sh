...
query="CHANGE MASTER TO MASTER_HOST='nextsj_master_t', MASTER_USER='nextsj_fixture', MASTER_PASSWORD='samjung', MASTER_LOG_FILE='${master_log_file}', MASTER_LOG_POS=${master_log_pos}"
